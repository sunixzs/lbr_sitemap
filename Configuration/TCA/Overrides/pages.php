...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addToAllTCAtypes ( "pages", "--div--;LLL:EXT:lbr_sitemap/Resources/Private/Language/locallang_db.xlf:pages.div.sitemap, tx_lbrsitemap_changefreq, tx_lbrsitemap_priority, tx_lbrsitemap_description, tx_lbrsitemap_image", "", "" );
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addToAllTCAtypes ( "pages_language_overlay", "--div--;LLL:EXT:lbr_sitemap/Resources/Private/Language/locallang_db.xlf:pages.div.sitemap, tx_lbrsitemap_changefreq, tx_lbrsitemap_priority, tx_lbrsitemap_description, tx_lbrsitemap_image", "", "" );

// add columnes for translation
$GLOBALS[ 'TCA' ][ 'pages_language_overlay' ][ 'interface' ][ 'showRecordFieldList' ] .= ',tx_lbrsitemap_changefreq,tx_lbrsitemap_priority,tx_lbrsitemap_description,tx_lbrsitemap_image';
